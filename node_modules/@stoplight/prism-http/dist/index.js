...
exports.createInstance = (defaultConfig, components) => prism_core_1.factory(defaultConfig, lodash_1.defaults(components, { route: router_1.default, validateInput: validator_1.validateInput, validateOutput: validator_1.validateOutput, validateSecurity: validator_1.validateSecurity, mock: mocker_1.default, forward: forwarder_1.default }));
