...
export declare class HttpPathValidator extends HttpParamsValidator<IHttpNameValue> {
    ...
    validate(target: IHttpNameValue, specs: IHttpPathParam[]): import("fp-ts/lib/Either").Either<import("fp-ts/lib/NonEmptyArray").NonEmptyArray<IPrismDiagnostic>, import("@stoplight/types").Dictionary<string, string>>;
}
