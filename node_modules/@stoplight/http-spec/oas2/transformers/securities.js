...
function translateToFlows(security) {
    ...
    const flowsDict = {
        ...
        accessCode: ['authorizationCode', Object.assign(Object.assign({}, tokenAndScope), { authorizationUrl: security.authorizationUrl })],
    };
...
function translateToSecurities(securities) {
    return securities.map(security => lodash_1.compact(security.map(translateToSingleSecurity)));
}
